  ...
  return (
    <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "40px 20px" }}>
      <style>{`
        ...
        .vendor-required{ background:#c91c1c; }
        .vendor-optional{ background:#8b8b8b; }
        ...
        @media screen and (max-width:768px){
          .vendor-form-title{ font-size:32px; }
          .vendor-form-row{
          ...
          .vendor-radio-label{ font-size:18px; }
          .vendor-submit{
            width:100%;
            height:60px;
            font-size:22px;
      ...
      <h1 className="vendor-form-title">店舗登録</h1>
            ...
            <div>
              <div className="vendor-radio-group">
                <div className="vendor-radio-row">
                  ...
                  />
                  <span className="vendor-radio-label">私は18歳以上です</span>
                </div>
                ...
                <div className="vendor-radio-row">
                  <input
                    ...
                    onChange={(e) => setAgeCheck(e.target.value)}
                  />
                  <span className="vendor-radio-label">私は18歳未満です</span>
                </div>
              </div>
