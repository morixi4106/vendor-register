...
const PAYMENT_PROVIDER_KOMOJU = "komoju";
...
export const SUPPORTED_PAYMENT_PROVIDERS = new Set([PAYMENT_PROVIDER_SHOPIFY_PAYMENTS, PAYMENT_PROVIDER_KOMOJU]);
...
export const PAYMENT_PROVIDER_LABELS = {
  ...
  [PAYMENT_PROVIDER_KOMOJU]: "KOMOJU"
};
