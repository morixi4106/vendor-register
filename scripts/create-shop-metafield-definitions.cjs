...
const definitions = [
  {
    name: 'Default Margin Rate',
    namespace: 'global_pricing',
    key: 'default_margin_rate',
    description: 'Default margin rate for pricing calculation',
    type: 'number_decimal',
    ownerType: 'SHOP',
  },
  {
    ...
    description: 'Payment fee rate for pricing calculation',
    type: 'number_decimal',
    ownerType: 'SHOP',
  },
  {
    name: 'Payment Fee Fixed',
    namespace: 'global_pricing',
    key: 'payment_fee_fixed',
    description: 'Fixed payment fee for pricing calculation',
    type: 'number_decimal',
    ownerType: 'SHOP',
  },
  {
    ...
    namespace: 'global_pricing',
    key: 'buffer_rate',
    description: 'Buffer rate for pricing calculation',
    type: 'number_decimal',
    ownerType: 'SHOP',
  }
];
