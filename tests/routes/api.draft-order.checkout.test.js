  ...
  return [
    {
      ...
      complianceProfile: {
        ...
        hsCode: '220421',
        customsDescriptionEn: 'Japanese wine',
        regulatoryCategory: 'GENERAL_GOODS',
        authenticityConfirmedAt: new Date('2026-09-01T00:00:00.000Z'),
        ipRightsConfirmedAt: new Date('2026-09-01T00:00:00.000Z'),
        applicabilityStatus: 'NOT_APPLICABLE',
        verificationLevel: 'DOCUMENT_REVIEWED',
        applicabilityReasonText:
          'No additional product-specific marketplace evidence is required for this test product.',
        applicabilitySourceUrl: 'https://example.com/compliance-review',
        applicabilityDecidedAt: new Date('2026-09-01T00:00:00.000Z'),
        applicabilityDecidedBy: 'test-operator',
